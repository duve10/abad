    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fw-bold" id="ModalLabel">Editar Calificación</h1>
                ...
                <form id="formEditCalificacion" method="POST" action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" class="form-control" name="idCalificacion" id="idCalificacion" autocomplete="off">
                        </div>
                    </div>
